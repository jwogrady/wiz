...
This module installs Neovim, a modern Vim fork:
  ...
  🚀 Modern Vim:         Fork of Vim with better defaults
  ⚙️  Lua Config:         Configuration in Lua instead of VimL
  🔌 Plugin Support:      Compatible with Vim plugins
  🎨 Better UI:          Modern terminal UI features
